...
RESOURCES += src/qt/iothome.qrc src/qt/iothome_locale.qrc

TRANSLATIONS += src/qt/locale/iothome_bg.ts \
                src/qt/locale/iothome_de.ts \
                src/qt/locale/iothome_en.ts \
                src/qt/locale/iothome_es.ts \
                src/qt/locale/iothome_fi.ts \
                src/qt/locale/iothome_fr.ts \
                src/qt/locale/iothome_it.ts \
                src/qt/locale/iothome_ja.ts \
                src/qt/locale/iothome_pl.ts \
                src/qt/locale/iothome_pt.ts \
                src/qt/locale/iothome_ru.ts \
                src/qt/locale/iothome_sk.ts \
                src/qt/locale/iothome_sv.ts \
                src/qt/locale/iothome_vi.ts \
                src/qt/locale/iothome_zh_CN.ts \
                src/qt/locale/iothome_zh_TW.ts
