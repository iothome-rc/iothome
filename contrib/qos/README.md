...
This means one can have an always-on iothomed instance running, and another local iothomed/iothome-qt instance which connects to this node and receives blocks from it.
