/* src/config/iothome-config.h.  Generated from iothome-config.h.in by configure.  */
/* src/config/iothome-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef IoTHome_CONFIG_H

#define IoTHome_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.iothome.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "IoTHome Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "IoTHome Core 2.4.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "iothome"
