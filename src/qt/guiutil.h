...
/** Utility functions used by the IoTHome Qt UI.
 */
namespace GUIUtil
{
...
// Render IoTHome addresses in monospace font
...
// Parse "iothome:" URI into recipient object, return true on successful parsing
