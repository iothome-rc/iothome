...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IOTH);
    unitlist.append(mIOTH);
    unitlist.append(uIOTH);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case IOTH:
        return QString("iothome");
    case mIOTH:
        return QString("miothome");
    case uIOTH:
        return QString::fromUtf8("uiothome");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IOTH:
            return QString("IOTH");
        case mIOTH:
            return QString("mIOTH");
        case uIOTH:
            return QString::fromUtf8("μIOTH");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IOTH:
            return QString("tIOTH");
        case mIOTH:
            return QString("mtIOTH");
        case uIOTH:
            return QString::fromUtf8("μtIOTH");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IOTH:
            return QString("IOTH");
        case mIOTH:
            return QString("Milli-IOTH (1 / 1" THIN_SP_UTF8 "000)");
        case uIOTH:
            return QString("Micro-IOTH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IOTH:
            return QString("TestIOTHs");
        case mIOTH:
            return QString("Milli-TestIOTH (1 / 1" THIN_SP_UTF8 "000)");
        case uIOTH:
            return QString("Micro-TestIOTH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
