...
public:
    ...
    void setZIoTHomeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzIOTH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzIOTH_clicked();
    void on_pushButtonZIoTHomeControl_clicked();
