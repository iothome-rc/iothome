                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IoTHome Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    int fontId = QFontDatabase::addApplicationFont(":/fonts/Prometo-Regular");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IoTHome address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iothome: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIOTH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IoTHome Core"), this);
    aboutAction->setStatusTip(tr("Show information about IoTHome Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IoTHome"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IoTHome addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IoTHome addresses"));
    ...
    openAction->setStatusTip(tr("Open a IoTHome: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IoTHome Core help message to get a list with possible IoTHome command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IoTHome Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IoTHome network", "", count));
}
...
{
    QString strTitle = tr("IoTHome Core"); // default title
