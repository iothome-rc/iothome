...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "IoTHome server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IoTHome features */
        {"iothome", "masternode", &masternode, true, true, false},
        {"iothome", "listmasternodes", &listmasternodes, true, true, false},
        {"iothome", "getmasternodecount", &getmasternodecount, true, true, false},
        {"iothome", "masternodeconnect", &masternodeconnect, true, true, false},
        {"iothome", "masternodecurrent", &masternodecurrent, true, true, false},
        {"iothome", "masternodedebug", &masternodedebug, true, true, false},
        {"iothome", "startmasternode", &startmasternode, true, true, false},
        {"iothome", "createmasternodekey", &createmasternodekey, true, true, false},
        {"iothome", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"iothome", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"iothome", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"iothome", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"iothome", "getmasternodescores", &getmasternodescores, true, true, false},
        {"iothome", "mnbudget", &mnbudget, true, true, false},
        {"iothome", "preparebudget", &preparebudget, true, true, false},
        {"iothome", "submitbudget", &submitbudget, true, true, false},
        {"iothome", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"iothome", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"iothome", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"iothome", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"iothome", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"iothome", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"iothome", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"iothome", "checkbudgets", &checkbudgets, true, true, false},
        {"iothome", "mnsync", &mnsync, true, true, false},
        {"iothome", "spork", &spork, true, true, false},
        {"iothome", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"iothome", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use iothomed, or the -server option to iothome-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> iothome-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15006/\n";
}
