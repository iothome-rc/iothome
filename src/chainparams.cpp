...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00009aa6ff05b8b02410e4bd1eb7d0ae200f0b524696f9797a40328ec4eee314"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1549834523, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x0000b78b210b557677fff228cef52cfce99571d28476cb1452d2bf8931004fd7"));
...
public:
    CMainParams()
    {
        ...
        vTreasuryRewardAddress="iLv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
        strNetworkID = "main";
        /**
        ...
        nDefaultPort = 15005;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // IoTHome starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // IoTHome: 1 day
        nTargetSpacing = 1 * 60; //IoTHome: 1 Min
        nMaturity = 6;
        nMasternodeCountDrift = 20;
        nMasternodeCollateralLimit = 1000; //MN collateral
        nMaxMoneyOut = 65000000 * COIN; //65M
        nMinStakeReserve = 1;
        /** Height or Time Based Activations **/
        nLastPOWBlock = 400; // premine
         ...
         *   vMerkleTree: e0028e
         */
    const char* pszTimestamp = "McKinsey predicts the IoT market will be worth 581B";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1549834523;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0x1cddd;


        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00009aa6ff05b8b02410e4bd1eb7d0ae200f0b524696f9797a40328ec4eee314"));
        assert(genesis.hashMerkleRoot == uint256("0x2106370e3944a98e8b9ddc86300769cb7819388797b23ae9cfeae43e8230d00a"));

        vSeeds.push_back(CDNSSeedData("explorer.iothome.store", "explorer.iothome.store"));         // Single node address
        vSeeds.push_back(CDNSSeedData("176.53.161.184", "176.53.161.184"));         // Single node address
        vSeeds.push_back(CDNSSeedData("176.53.161.189", "176.53.161.189"));         // Single node address
        vSeeds.push_back(CDNSSeedData("176.53.161.182", "176.53.161.182"));         // Single node address
        vSeeds.push_back(CDNSSeedData("176.53.163.101", "176.53.163.101"));         // Single node address
        vSeeds.push_back(CDNSSeedData("176.53.163.53", "176.53.163.53"));         // Single node address
        ...
        strObfuscationPoolDummyAddress = "iLv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // IoTHome: 1 day
        nTargetSpacing = 1 * 60;  // IoTHome: 1 minute
        nLastPOWBlock = 2880;
        nMaturity = 15;
        ...
        genesis.nTime = 1549835142;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0x13a5b;


            hashGenesisBlock = genesis.GetHash();
            assert(hashGenesisBlock == uint256("0x0000b78b210b557677fff228cef52cfce99571d28476cb1452d2bf8931004fd7"));
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // IoTHome: 1 day
        nTargetSpacing = 1 * 60;        // IoTHome: 1 minutes
