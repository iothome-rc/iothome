...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IoTHome Core iothome-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  iothome-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iothome transaction") + "\n" +
                               "  iothome-tx [options] -create [commands]   " + _("Create hex-encoded iothome transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded iothome transaction
