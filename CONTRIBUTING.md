Contributing to IoTHome Core
============================

The IoTHome Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IoTHome Core project, and is not to be
confused with overall IoTHome Network Protocol consensus changes.

Whether a pull request is merged into IoTHome Core rests with the project merge
...
Patches that change IoTHome consensus rules are considerably more involved than
...
Where a patch set proposes to change the IoTHome consensus, it must have been
...
The project leader is the release manager for each IoTHome Core release.
