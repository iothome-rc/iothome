UNIX BUILD NOTES
====================
Some notes on how to build IoTHome in Unix.
...
memory available when compiling IoTHome Core. With 512MB of memory or less
...
If you want to build IoTHome-Qt, make sure that the required packages for Qt development
...
# Configure IoTHome Core to use our own-built instance of BDB
cd $IoTHome_ROOT
...
Security
--------
To help make your IoTHome installation more secure by making certain attacks impossible to
