TOR SUPPORT IN IoTHome
=======================

It is possible to run IoTHome as a Tor hidden service, and connect to such services.
...
Run IoTHome behind a Tor proxy
----------------------------------

The first step is running IoTHome behind a Tor proxy. This will already make all
...
List of known IoTHome Tor relays
------------------------------------
```
onion:
```
